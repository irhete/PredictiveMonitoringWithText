    ...
    for cls_method in cls_methods:
        ...
        for k in [10, 25, 50, 75, 100, 200]:
            for tfidf in [True, False]:
                ...
                # test
                predictive_monitor.test(test_chunk, confidences, evaluate=True, case_lengths=None, output_filename="cv_results/lda_k%s_%s%s_part%s"%(k, ("tfidf_" if tfidf else ""), cls_method, part))
